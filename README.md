...
[![LegendOfTheMoai Showcase](https://cdn.allthepics.net/images/2025/02/13/Thumbnail6.png)](https://www.youtube.com/watch?v=0Ril2Wkut3g)

# Features

<details>
<summary>Moai Enemy and Variants</summary>
<br>
...
<img src="https://i.imgur.com/TquNrQf.png" width="1220" height="540"/>
...
<details>
<summary>Secrets and Items</summary>

# Volcanic Eruption

Volcanic eruptions are commonplace on easter island, causing massive destruction.
However, there is a way to figure out exactly WHEN the volcano will erupt (found on the island itself)

Eruption Showcase:
[![Volcanic Eruption Showcase](https://i.imgur.com/VlP1YtJ.jpeg)](https://youtu.be/IAu-HJZyc9w)

# The Golden Head

Valuable item that goes Heugh???
Guaranteed spawn outside on easter island. May be found inside the factory on Easter Island.

[![Golden Head Showcase](https://i.imgur.com/7nU7mFj.png)](https://youtu.be/cGHZDsMCFe8)

# E-GHF

An advanced artifact capable of seeking out riches and monsters.
So how exactly did a living rock create this... thing?

[![E-GHF Showcase](https://i.imgur.com/jZ31jNs.png)


# The lab

The lab is focused on infusing objects with quantum energy, but it is powered down somehow...
There must be another way to create quantum objects.

[![Lab Room](https://cdn.allthepics.net/images/2025/02/13/Screenshot-2025-02-13-161434.png)

# The Test Facility
Includes some 'interesting' tests on quantum objects. It also has a few
buttons and gadgets to mess with. What does this big red button do?
[![Facility Room 1](https://cdn.allthepics.net/images/2025/02/13/Screenshot-2025-02-13-161200.md.png)
[![Facility Room 2](https://cdn.allthepics.net/images/2025/02/13/Screenshot-2025-02-13-161233.md.png)

# A hidden second interior?
Good luck finding this one. It requires you to connect many secrets together to find it.

[![Cave](https://cdn.allthepics.net/images/2025/02/13/Screenshot-2025-02-13-212644.png)
</details>

<details>
<summary>Credits</summary>
Credit to C4DNerd for the King Harkinian model (from that funny zelda meme). 
...
Credit to Batzorig Vanachig for his amazing mongolian throat music performance (used now as Item Ship music)
...
* Quantum Storm is coming back soon!
* Improving island visual aesthetics.
* Improving a new secret area (called heaven), and more special body modifications in the area.

I am open to any feedback and/or requests for new features.

* Check out the new discord server for the Legend Of The Moai!
https://discord.gg/7gPKuFRFax

or message me through my email at bcs4313@rit.edu. 
you can also find me on the Lethal Company modding discord:
...
1.6.0
- Added a somewhat rare item: Gum Gum!
Left click to consume your gum gum, granting you temporary stats.
...
1.6.5
- Fixed a common mod compatibility issue with quantum items and transferring the quantum property.

1.7.0
- Added secret boss fight that unlocks after completing the main easter egg.
- Added a (somewhat) hidden path up the volcano that doesn't require a jetpack.
- Added a satellite on the map that calls in a space ship with lore (the satellite will do more in the future)
- Added a space ship that crash lands on the moon from calling the satellite (will add random chance to crash on a day soon)
- Fixed some contrasting shadows and ambient light issues.

1.7.1
- Hotfix for the ship being unable to leave if everyone dies to the boss and/or tries to leave.

1.7.2
- Hotfixes.

1.7.3
- Update for v70+ support in Lethal Company.
- Mod size reduction: 96.6 MB -> 83.2 MB

1.7.4
- (Attempted compatibility with weather registry...)
- More v70 compatibility fixes, including issues with item/item interactions in labs.

1.7.5
- Removed compatibility with weather registry for now.
- Even more v70 fixes, including Gum Gum now functioning properly.

1.7.6
- Full compatibility with WeatherRegistry https://thunderstore.io/c/lethal-company/p/mrov/WeatherRegistry/ (Fully Tested)

1.8.0
- BETA RELEASE. Will be edited in the very near future.
...
1.8.1
- Fixed indoor lightning being too bright.
...
1.8.3
- VERY HEAVY optimization fix. Will result in a huge boost in framerate.
